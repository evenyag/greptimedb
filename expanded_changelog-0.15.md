...
* feat: add `granularity` and `false_positive_rate` options for indexes by @zhongzc in https://github.com/GreptimeTeam/greptimedb/pull/6416
* feat: override logical table's partition key indices by @fengjiachun in https://github.com/GreptimeTeam/greptimedb/pull/6385
* feat(pipeline): support Loki API by @shuiyisong in https://github.com/GreptimeTeam/greptimedb/pull/6390
* fix: fix dest_keys chunks bug in TombstoneManager by @WenyXu in https://github.com/GreptimeTeam/greptimedb/pull/6432
* fix: correct MAX_EXECUTION_TIME timeout calculation by @evenyag in https://github.com/GreptimeTeam/greptimedb/pull/6444
* fix: remap column indices on overriding logical table partitions by @waynexia in https://github.com/GreptimeTeam/greptimedb/pull/6446
* refactor: avoid adding feature to parameter by @fengys1996 in https://github.com/GreptimeTeam/greptimedb/pull/6391
* feat: `Collider` for playing with `PartitionRule` by @waynexia in https://github.com/GreptimeTeam/greptimedb/pull/6399
* feat!: point matrix based partition rule checker by @waynexia in https://github.com/GreptimeTeam/greptimedb/pull/6431
* fix: label_replace and label_join functions when used as sub‐expressions by @killme2008 in https://github.com/GreptimeTeam/greptimedb/pull/6443
* feat: skip rule checker on ingestion by @waynexia in https://github.com/GreptimeTeam/greptimedb/pull/6453
* fix: enable max_execution time for other read only statements by @evenyag in https://github.com/GreptimeTeam/greptimedb/pull/6454
