...
use arrow1::array::{Array, ArrayData, ArrayRef, ArrayBuilder, ArrayIter};
use snafu::{OptionExt, ResultExt};

use crate::arrow1_array::{BinaryArray, MutableBinaryArray};
use crate::data_type::ConcreteDataType;
use crate::error::{self, Result};
use crate::scalars2::{ScalarVector, ScalarVectorBuilder};
use crate::serialize::Serializable;
use crate::value::{Value, ValueRef};
use crate::vectors2::{self, MutableVector, Validity, Vector, VectorRef};
...
impl Vector for BinaryVector {
    ...
    fn validity(&self) -> Validity {
        vectors2::impl_validity_for_vector!(self.array)
    }
    ...
    fn get(&self, index: usize) -> Value {
        vectors2::impl_get_for_vector!(self.array, index)
    }

    fn get_ref(&self, index: usize) -> ValueRef {
        vectors2::impl_get_ref_for_vector!(self.array, index)
    }
}
...
impl MutableVector for BinaryVectorBuilder {
    ...
    fn extend_slice_of(&mut self, vector: &dyn Vector, offset: usize, length: usize) -> Result<()> {
        vectors2::impl_extend_for_builder!(self, vector, BinaryVector, offset, length)
    }
}
...
vectors2::impl_try_from_arrow_array_for_vector!(BinaryArray, BinaryVector);

#[cfg(test)]
mod tests {
    use arrow1::datatypes::DataType as ArrowDataType;
    use common_base::bytes::Bytes;
    use serde_json;

    use super::*;
    use crate::arrow1_array::BinaryArray;
    ...
    // TODO(yingwen): Impl Int32Vector and create_mutable_vector() of DataType returns vectors2::Vector
    // #[test]
