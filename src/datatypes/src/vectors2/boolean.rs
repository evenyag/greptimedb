...
use arrow1::array::{Array, ArrayRef, ArrayIter, ArrayData, ArrayBuilder, BooleanArray, BooleanBuilder};
...
impl MutableVector for BooleanVectorBuilder {
    ...
    fn extend_slice_of(&mut self, vector: &dyn Vector, offset: usize, length: usize) -> Result<()> {
        vectors2::impl_extend_for_builder!(self, vector, BooleanVector, offset, length)
    }
}
...
vectors2::impl_try_from_arrow_array_for_vector!(BooleanArray, BooleanVector);
