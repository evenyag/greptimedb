...
async fn test_two_phase_series_scan() {
    for use_index in [false, true] {
        check_two_phase_series_scan(use_index).await;
    }
}

async fn check_two_phase_series_scan(use_index: bool) {
